...
nc-store-contract-drone-hunt-mode-tooltip = An enemy drone shuttle appears after acceptance. Find the contract proof core and bring it back to the trader.
nc-store-contract-drone-hunt-turn-in-header = Turn in core:
nc-store-contract-drone-hunt-turn-in-note = The drone shuttle carries the proof item: { $item }. Take it and bring it to the trader.
nc-store-contract-drone-hunt-status-available = The contract drone shuttle appears after acceptance.
nc-store-contract-drone-hunt-status-progress = Recover the drone shuttle contract core: { $progress }/{ $required }.
...
nc-store-contract-drone-hunt-action-progress = Proof core: { $progress }/{ $required }. Recover it from the drone shuttle.
nc-store-contract-drone-hunt-action-ready = Turn in the proof core to the trader.
nc-store-contract-drone-hunt-target-lost = The contract drone shuttle and proof core were lost. The contract has failed.
