...
nc-store-contract-drone-hunt-mode-tooltip = После принятия появится вражеский дрон-шаттл. Найдите контрактное ядро-доказательство и принесите его торговцу.
nc-store-contract-drone-hunt-turn-in-header = Сдать ядро:
nc-store-contract-drone-hunt-turn-in-note = На дрон-шаттле находится доказательство: { $item }. Заберите его и принесите к торговцу.
nc-store-contract-drone-hunt-status-available = Контрактный дрон-шаттл появится после принятия.
nc-store-contract-drone-hunt-status-progress = Заберите контрактное ядро дрон-шаттла: { $progress }/{ $required }.
...
nc-store-contract-drone-hunt-action-progress = Ядро-доказательство: { $progress }/{ $required }. Заберите его с дрон-шаттла.
nc-store-contract-drone-hunt-action-ready = Сдайте ядро-доказательство торговцу.
nc-store-contract-drone-hunt-target-lost = Контрактный дрон-шаттл и ядро-доказательство потеряны. Контракт сорван.
